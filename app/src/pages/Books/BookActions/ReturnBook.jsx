...
import { getAllBorrowings, returnBook } from '../../../api/BorrowBookServices';
  ...
  useEffect(() => {
    setHeaderData({
      ...
      breadcrumbs: [
        ...
        {label:"Vrati knjigu", to: `/books/return-book/${bookId}`}
      ],
      actions: (
  ...
  useEffect(() => {
    ...
    const handleReturnBook = async () => {
      ...
      try {
        ...
        toast.success("Uspješno ste vratili knjigu!");
      ...
      fetchAllEvidentionLoading ? (
        ...
        <div className='writeoff-wrapper'>
          ...
          <div className="form-buttons">
              <button className="save-btn" onClick={handleReturnBook} disabled={!rowSelectionModel || submitting}>
                <BookDown /> VRATI KNJIGU
              </button>
