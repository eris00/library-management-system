  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem onClick={() => {navigate(`/books/books/rent-book/${row.id}`)}}><div className="menu-item__student"><BookUser className='dropdown-icons'/>Izdaj Knjigu</div></MenuItem>
        <MenuItem onClick={() => {navigate(`/books/books/writeoff-book/${row.id}`)}}><div className="menu-item__student"><BookUser className='dropdown-icons'/>Otpiši Knjigu</div></MenuItem>
      </Menu>
    </>
